        ...
        <h3 className="text-2xl font-semibold text-blue-600 mb-4">Featured Products</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-100 p-4 rounded-lg shadow-sm text-center">
              <Image className='border rounded-[10px] ' 
              height={10} width={300}
               src={`/hq720.jpg`} 
               alt={`High Quality Tech Products`}></Image>
              <h4 className="text-xl font-semibold mt-[20px]">Product 1</h4>
              <p className="text-gray-700 mt-[7px]">High-quality and durable.</p>
              <Link href="https://www.thetimes.com/life-style/luxury/article/best-luxury-tech-gadgets-all-time-technology-men-women-times-luxury-92b569bq6" rel="noopener noreferrer" target='_blank'><button className=" mt-[12px] border rounded-[12px] bg-gradient-to-r from-blue-700  via-blue-400 to-blue-300 hover:bg-black w-[140px] h-[40px] text-white">Learn More</button></Link>
            </div>
            ...
            <Image className='border rounded-[10px]' width={300} height={10} src={`/maxresdefault (1).jpg`} alt={`Innovative design Products`}></Image>
              ...
              <div className='mt-[12px]'><Link href="https://innovativetecdesign.com/" rel="noopener noreferrer" target='_blank'><button className=" border rounded-[12px] bg-gradient-to-r from-blue-700  via-blue-400 to-blue-300 hover:bg-blue-600 w-[140px] h-[40px] text-white">Learn More</button></Link></div>
            </div>
            ...
            <Image className='border rounded-[10px]' width={300} height={10} src={`/images-2023-07-02T113436.297.jpeg`} alt={`Top Rated Products`}></Image>
              ...
              <div className='mt-[10px]'><Link href="https://www.practitest.com/resource-center/blog/top-performance-testing-tools/" rel="noopener noreferrer" target='_blank'><button className=" border rounded-[12px] bg-gradient-to-r from-blue-700  via-blue-400 to-blue-300 hover:bg-blue-600 w-[140px] h-[40px] text-white">Learn More</button></Link></div>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-100 p-4 rounded-lg shadow-sm text-center">
              ...
              <Link href="https://www.forbes.com/sites/technology/article/sustainable-technology/" rel="noopener noreferrer" target='_blank'><button className=" mt-[12px] border rounded-[12px] bg-gradient-to-r from-blue-700  via-blue-400 to-blue-300 hover:bg-black w-[140px] h-[40px] text-white">Learn More</button></Link>
            </div>
            ...
            <Image className='border rounded-[10px]' width={300} height={10} src={`/The-most-futuristic-tech-gadgets-you-will-want-to-buy-someday-blog-featured.jpeg`} alt={`Health and Wellness Products`}></Image>
              ...
              <div className='mt-[12px]'><Link href="https://www.myvitaminstore.pk/collections/health-wellness?srsltid=AfmBOopHbDoS9-Mdjkw5Z1wlQHFkRrBnFxtKRQMUQF6QEO3iX2hylOBm" rel="noopener noreferrer" target='_blank'><button className=" border rounded-[12px] bg-gradient-to-r from-blue-700  via-blue-400 to-blue-300 hover:bg-blue-600 w-[140px] h-[40px] text-white">Learn More</button></Link></div>
            </div>
            ...
            <Image className='border rounded-[10px]' width={400} height={10} src={"/images.jpeg"} alt={`Educational and productivity Products`}></Image>
              ...
              <div className='mt-[12px]'><Link href="https://www.edutopia.org/article/productivity-tools-more-teachers-should-know-about/" rel="noopener noreferrer" target='_blank'><button className=" border rounded-[12px] bg-gradient-to-r from-blue-700  via-blue-400 to-blue-300 hover:bg-blue-600 w-[140px] h-[40px] text-white">Learn More</button></Link></div>
            </div>
          </div>
        </section>
        ...
        <section className="mt-[40px]">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow-sm">
              ...
              <Image className='w-[250px] h-[160px] ml-[100px]' height={10} width={300} src={`/DALL·E 2025-02-11 13.59.15 - A conceptual illustration of Quantum Computing, featuring a futuristic quantum chip with glowing qubits, interconnected by quantum circuits. The image.webp`} alt={`Quantum Computer img`}/>
              </div>
            </div>
            <div className="bg-gray-100 p-4 rounded-lg shadow-sm">
              <div className='flex'>
